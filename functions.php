...
Add theme supports
 **********************/
function nivijah_theme_support() {
    // Add language supports.
    load_theme_textdomain('nivijah', get_template_directory() . '/lang');
...
if(!function_exists('nivijah_entry_meta')) :
    function nivijah_entry_meta() {
        echo '<span class="byline author">'. __('Written by', 'nivijah') .' <a href="'. get_author_posts_url(get_the_author_meta('ID')) .'" rel="author" class="fn">'. get_the_author() .', </a></span>';
