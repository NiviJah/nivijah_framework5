    ...
    lib_methods : {
      ...
      loaded : function (image, callback) {
        ...
        function bindLoad () {
          ...
          if (/MSIE (\d+\.\d+);/.test(navigator.usernivijah)) {
